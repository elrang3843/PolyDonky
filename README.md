...
> 현재 저장소에는 사양 문서(`README.md`, `IWPF.md`, `CLAUDE.md`)만 포함되어 있고,
> 실행 가능한 바이너리·릴리스는 아직 제공되지 않습니다.
> 진행 상황은 [Issues](../../issues) / [Releases](../../releases) 페이지에서 확인하세요.
...
릴리스 빌드가 준비되면 [Releases 페이지](../../releases)에서 다운로드할 수 있습니다.
